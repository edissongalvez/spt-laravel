    ...
    <div class="list-group">
        @forelse ($tesis as $i)
            ...
            <div class="d-flex gap-2 w-100 justify-content-between">
                ...
                <p class="mb-0 opacity-75">Tesista: <i>{{ $i->project->tesista }}</i>. Inicio: <i>{{ $i->project->finicio }}</i>. Fin: <i>{{ $i->project->ftermino }}</i>.</p>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form action="{{ route('ss.checkThesis', $i->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
